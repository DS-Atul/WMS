              ...
              {circle_btn1 ? (
                <CardBody>
                  <Row>
                    ...
                    {/* <Col lg={4} md={6} sm={6}>
                      <div className="mb-3">
                        <Label className="header-child">Callibration Effective From *</Label>
                        <Input
                        type="date"
                        className="form-control-md"
                        id="input"
                        ...
                        invalid={callibration_from_date == "" && callibration_from_date_error}
                        />
                         {
                            callibration_from_date == "" && callibration_from_date_error ? (
                              <FormFeedback type="invalid">
                      ...
                      <Col lg={4} md={6} sm={6}>
                      <div className="mb-3">
                        <Label className="header-child">Callibration Effective To *</Label>
                        <Input
                        type="date"
                        className="form-control-md"
                        id="input"
                        ...
                        invalid={
                          callibration_to_date == "" &&
                          callibration_to_date_error
                        }
                        />
                         {
                            callibration_to_date == "" && callibration_to_date_error ? (
                              <FormFeedback type="invalid">
                                Callibration to Date is required
                              </FormFeedback>
                            ):null
                          }
                      </div>
                    ...
                    {/* <Col lg={4} md={6} sm={6}>
                      <div className="mb-3">
                        <Label className="header-child">Callibration Certificate *</Label>
                        <Input
                       type="file"
                         className="form-control-md"
                         id="input"
                      ...
                      <Col lg={4} md={6} sm={6}>
                      <div className="mb-3">
                        <Label className="header-child">Callibration Certificate Issued By *</Label>
                        <Input
                       type="text"
                         className="form-control-md"
                         id="input"
                         value={callibration_certificate_issue_by}
                         onChange={(val) =>{
                          setcallibration_certificate_issue_by(val.target.value);
                         }}
                       />
                      </div>
                      </Col> */}
