    ...
    <div className="m-2" ref={ref} id={"invoice_div"}>
      ...
      >
        <tbody>
          ...
          <tr>
            <td colSpan={2}>{pkg_list[0][0]}</td>
            <td colSpan={2}>{pkg_list[0][1]}</td>
            <td colSpan={2}>{pkg_list[0][2]}</td>
            <td>{pkg_list[0][3]}</td>
          </tr>

          <tr>
            <td colSpan={2}>{pkg_list[1][0]}</td>
            <td colSpan={2}>{pkg_list[1][1]}</td>
            <td colSpan={2}>{pkg_list[1][2]}</td>
            <td>{pkg_list[1][3]}</td>
          </tr>
